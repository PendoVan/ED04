...
institucional. La Capa de Negocio concentra la lógica principal del sistema, donde los servicios de reserva, disponibilidad y notificación aplican las reglas definidas (validación de topes, 
bloqueos y horarios). Esta capa actúa como intermediaria entre la presentación y los datos, procesando las solicitudes y asegurando la coherencia del flujo. Finalmente, la Capa de Datos 
