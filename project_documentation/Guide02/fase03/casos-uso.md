...
##
| Caso de uso: Visualizar   calendario |                                                                                                    |
|---------------------------------------|----------------------------------------------------------------------------------------------------|
| ID:                                   | CUS-02                                                                                             |
...
| El caso de uso finaliza.                                                                                |
##
| Caso de uso: Ver lista de reservas propias |                                                                                                                                                             |
|----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ID:                                          | CUS_04                                                                                                                                                      |
...
| El sistema muestra el listado de reservas propias.                                        |
...
|------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| ID:                                | CUS-06                                                                                                                 |
| Descripción:                       | Muestra al consejero un calendario con información de las reservas registradas y le permite gestionar los bloqueos. |
| Actor:                             | Consejero.                                                                                                             |
...
| El sistema le muestra un calendario con las reservas registradas.                                                    |
| El sistema le da la opción de bloquear una franja o un día, por eventos o mantenimiento.  |
| El sistema le permite al Consejero aplicar hacer una exportación simple del listado. |
| El sistema aplica el bloqueo indicado, o realiza la exportación simple, dependiendo de la opción optada por el Consejero.                                              |
| El caso de uso finaliza.                                                                                                                 |
##
...
| Flujo principal                                                                                  |
|--------------------------------------------------------------------------------------------------|
| El Consejero selecciona una fecha del calendario.                                         |
| El Consejero elije si va a bloquear la fecha seleccionado o un rango de horas de esa fecha. |
| El Consejero define el horario del bloqueo.                     |
...
|------------------------------------|----------------------------------------------------------------------------------------|
| ID:                                | CUS-07                                                                                 |
| Descripción:                       | Permite al consejero notificar al usuario el estado en el que se encuentra su reserva (si hubo bloqueos en el día de su reserva). |
| Actor:                             | Consejero.                                                                             |
| Precondición:                      | El Consejero está autenticado.                                                         | 
...
| Flujo principal                                                                                                                               |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
| El Consejero ha bloqueado una fecha en el calendario.                                                                                                   |
